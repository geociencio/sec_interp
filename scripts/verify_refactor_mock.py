...
from sec_interp.core.domain import StructureMeasurement, GeologySegment  # noqa: E402
from sec_interp.core.services.structure_service import StructureService  # noqa: E402
from sec_interp.core.services.geology_service import GeologyService  # noqa: E402
...
def test_structure_service():
    ...
    mock_scu.prepare_profile_context.return_value = (
        MockQgsGeometry(),
        MockQgsPointXY(0, 0),
        mock_da,
    )
...
def test_geology_service():
    ...
    mock_da.measureLine.side_effect = [
        0.0,
        10.0,
        0.0,
        100.0,
    ...
    mock_scu.get_line_vertices.return_value = [
        MockQgsPointXY(0, 0),
        MockQgsPointXY(10, 10),
    ]
    ...
    inter_feat = MockQgsFeature(
        attributes={"unit_name": "Granite", "other": 1}, geometry=MockQgsGeometry()
    )
