# Next Steps - Phase v3.8.0 (Updated 2026-09-12)
...
- **Manual follow-up pending**: publish the draft and upload the ZIP to plugins.qgis.org.

## 🚀 How to Resume
1. Run `/start-session`.
2. Continue with Goal 1.1 (symbology preview), Fase 1 adaptive VE (1.2), or tech debt 2.1/2.2/2.3.
3. (Manual) Publish `v3.7.2` draft + upload ZIP to plugins.qgis.org to clear the portal's Qt6 flags.
