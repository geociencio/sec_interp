...
- **Merge**: fast-forward a `main` (37 commits por delante de `origin/main`, sin push).
...
## 🚀 Próximo: Release v3.8.0 (PENDIENTE)

- Ejecutar `/release-plugin` (checklist consolidada de 10 docs en workflow/skill):
  bump de versión (metadata/pyproject/conf.py), `docs/docsec/CHANGELOG.md` (español,
  está atrás — solo llega a 3.7.0), release notes, DEVELOPMENT_LOG, QUICK_REFERENCE,
  `AI_CONTEXT.md`.
- Antes: `git push origin main` (main local va 37 commits por delante).
