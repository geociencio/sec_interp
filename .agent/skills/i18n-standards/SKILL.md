---
name: i18n-standards
description: Standards and best practices for internationalization (i18n) in SecInterp. Use when adding or modifying user-facing strings, running translation tools (update-strings.sh), triaging MISSING_I18N analyzer flags, or using the /i18n-maintenance workflow.
---
