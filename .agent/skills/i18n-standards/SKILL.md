...
trigger: when adding or modifying user-facing strings, running translation tools (update-strings.sh), triaging MISSING_I18N analyzer flags, or using the /i18n-maintenance workflow.
---
