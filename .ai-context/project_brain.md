...
- **Score de Calidad**: 89.9/100
- **Score Cumplimiento QGIS**: 100.0/100
- **Líneas de Código**: 12,416 en 91 módulos.
- **Complejidad Promedio**: 12.4. (Módulos más complejos: `gui/main_dialog_preview.py`, `core/services/drillhole_service.py`, `core/validation/project_validator.py`).
