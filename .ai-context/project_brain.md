...
- **Líneas de Código**: 12,342 en 91 módulos.
- **Complejidad Promedio**: 12.3. (Módulos más complejos: `gui/main_dialog_preview.py`, `core/services/drillhole_service.py`, `gui/preview_layer_factory.py`).
