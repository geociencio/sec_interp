...
- **Líneas de Código**: 12,642 en 93 módulos.
- **Complejidad Promedio**: 11.8. (Módulos más complejos: `core/services/drillhole_service.py`, `core/validation/project_validator.py`, `gui/preview_layer_factory.py`).
