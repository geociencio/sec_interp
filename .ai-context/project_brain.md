...
- **Líneas de Código**: 12,815 en 93 módulos.
- **Complejidad Promedio**: 12.6. (Módulos más complejos: `gui/main_dialog_preview.py`, `core/services/drillhole_service.py`, `core/validation/project_validator.py`).
