...
- **Líneas de Código**: 12,337 en 91 módulos.
- **Complejidad Promedio**: 12.1. (Módulos más complejos: `gui/main_dialog_preview.py`, `core/services/drillhole_service.py`, `core/validation/project_validator.py`).
