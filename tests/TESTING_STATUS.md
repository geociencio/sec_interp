...
| Metric | Value | Status |
| :--- | :--- | :--- |
| **Total Tests** | <!-- TOTAL_TESTS -->606<!-- /TOTAL_TESTS --> | ✅ Stable |
| **Platform** | Docker (QGIS 3.x) | 🐳 Active |
| **Last Updated** | <!-- LAST_UPDATE -->2026-09-19<!-- /LAST_UPDATE --> | 🕒 Auto |
...
| **GUI Components** | <!-- GUI_COUNT -->211<!-- /GUI_COUNT --> | ██████░░░░ 60% | 🏗️ |
...
- **tests/integration/test_async_orchestrators.py**: 4 tests
- **tests/integration/test_export_service_e2e.py**: 9 tests
- **tests/integration/test_export_workflow.py**: 2 tests
- **tests/integration/test_geology_structure_workflow.py**: 19 tests
