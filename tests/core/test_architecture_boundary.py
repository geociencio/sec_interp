...
CORE_VIOLATIONS: dict[str, frozenset[str]] = {
    ...
    "utils/geometry_utils/measurement.py": frozenset({"qgis.core"}),
    "utils/geometry_utils/optimization.py": frozenset({"qgis.core"}),
    ...
    "utils/resource_manager.py": frozenset({"qgis.core", "QgsProject.instance()"}),
