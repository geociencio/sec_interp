...
- **Total Modules**: 227
- **Source Lines (SLOC)**: 22,798
- **Total Physical Lines**: 35,410
- **Functions**: 0
- **Classes**: 0
- **Average Complexity**: 0.0
- **Avg Maintenance Index**: 0.0
- **Most Complex Modules**: tests/mocks/qgis_geometry.py, gui/preview_layer_factory.py, core/services/drillhole/drillhole_orchestrator.py
...
- **validate_positive** in `core/validation/validators.py` (50%)
  - _Evidence: Function contains and returns inner 'validator'_
- **validate_non_negative** in `core/validation/validators.py` (50%)
  - _Evidence: Function contains and returns inner 'validator'_
### Observer
...
- **core/domain/task_inputs.py**: __future__.annotations
