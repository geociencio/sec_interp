...
- **Total Modules**: 186
- **Source Lines (SLOC)**: 18,972
- **Total Physical Lines**: 29,640
- **Functions**: 0
- **Classes**: 0
- **Average Complexity**: 0.0
- **Avg Maintenance Index**: 0.0
- **Most Complex Modules**: gui/dialog_state_manager.py, tests/mocks/qgis_geometry.py, gui/preview_layer_factory.py
