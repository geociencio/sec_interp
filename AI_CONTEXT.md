...
- **Total Modules**: 191
- **Source Lines (SLOC)**: 19,395
- **Total Physical Lines**: 30,248
- **Functions**: 0
- **Classes**: 0
...
## 🔄 GIT AND EVOLUTION
### Top Hotspots:
- `gui/main_dialog.py` (70 commits)
- `gui/main_dialog_preview.py` (55 commits)
- `gui/preview_renderer.py` (48 commits)
- `core/services/geology_service.py` (44 commits)
- `resources/resources.py` (40 commits)
### Recent Churn (30 days):
- Total lines changed: 180990

## 🔑 PROJECT KEYWORDS
- **Technologies**: .pyc, .json, .py, .html, .doctree, .png, .log, .md
