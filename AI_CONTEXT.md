...
- **Total Modules**: 182
- **Source Lines (SLOC)**: 18,261
- **Total Physical Lines**: 28,323
- **Functions**: 0
- **Classes**: 0
...
- `gui/main_dialog_preview.py` (52 commits)
- `gui/preview_renderer.py` (45 commits)
- `core/services/geology_service.py` (39 commits)
- `core/services/drillhole_service.py` (35 commits)
### Recent Churn (30 days):
- Total lines changed: 179048

## 🔑 PROJECT KEYWORDS
- **Technologies**: .json, .pyc, .html, .py, .doctree, .png, .log, .md
