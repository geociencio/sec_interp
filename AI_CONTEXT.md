...
- **Total Modules**: 184
- **Source Lines (SLOC)**: 18,581
- **Total Physical Lines**: 29,375
- **Functions**: 0
- **Classes**: 0
...
- **complexity_refactoring**: Consider breaking down large logic
- **module_too_large**: Large module (749 lines)
### core/services/geology_service.py
- **complexity_refactoring**: Consider breaking down large logic

## 🔄 GIT AND EVOLUTION
### Top Hotspots:
- `gui/main_dialog.py` (65 commits)
- `gui/main_dialog_preview.py` (54 commits)
