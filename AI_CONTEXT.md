...
- **functions_too_long**: Very long functions (average 63.8 lines/function).
...
## 🔑 PROJECT KEYWORDS
- **Technologies**: .py, .dat, .pyi, .sip, .pyc, .qml, .so, .mo
