...
- **Total Modules**: 191
- **Source Lines (SLOC)**: 19,393
- **Total Physical Lines**: 30,246
- **Functions**: 0
- **Classes**: 0
...
- `core/services/geology_service.py` (43 commits)
- `resources/resources.py` (39 commits)
### Recent Churn (30 days):
- Total lines changed: 181163
