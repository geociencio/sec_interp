...
- **Total Modules**: 186
- **Source Lines (SLOC)**: 19,022
- **Total Physical Lines**: 29,686
- **Functions**: 0
- **Classes**: 0
...
graph TD
    ...
    class test_structure_service module;
...
## 🔄 GIT AND EVOLUTION
### Top Hotspots:
- `gui/main_dialog.py` (67 commits)
- `gui/main_dialog_preview.py` (55 commits)
- `gui/preview_renderer.py` (47 commits)
- `core/services/geology_service.py` (42 commits)
- `core/services/drillhole_service.py` (37 commits)
### Recent Churn (30 days):
- Total lines changed: 171179
