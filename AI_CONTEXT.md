...
- **Total Modules**: 105
- **Source Lines (SLOC)**: 11,144
- **Total Physical Lines**: 18,056
- **Functions**: 0
- **Classes**: 0
...
- **module_too_large**: Large module (455 lines)
### core/services/geology_service.py
- **complexity_refactoring**: Consider breaking down large logic
- **module_too_large**: Large module (429 lines)
