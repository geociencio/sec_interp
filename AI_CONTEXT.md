...
- **Total Modules**: 186
- **Source Lines (SLOC)**: 19,160
- **Total Physical Lines**: 29,911
- **Functions**: 0
- **Classes**: 0
- **Average Complexity**: 0.0
- **Avg Maintenance Index**: 0.0
- **Most Complex Modules**: tests/mocks/qgis_geometry.py, gui/dialog_state_manager.py, gui/preview_layer_factory.py
