...
- **Total Modules**: 115
- **Source Lines (SLOC)**: 10,948
- **Total Physical Lines**: 17,879
- **Functions**: 0
- **Classes**: 0
- **Average Complexity**: 0.0
- **Avg Maintenance Index**: 0.0
- **Most Complex Modules**: gui/main_dialog_settings.py, gui/preview_layer_factory.py, exporters/interpretation_3d_exporter.py
...
- **complexity_refactoring**: Consider breaking down large logic
- **module_too_large**: Large module (403 lines)
