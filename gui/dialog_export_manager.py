...
class ExportManager:
            ...
            with PerformanceTimer("Total Preview Export Time", self.metrics):
                ...
                if success:
                    self.dialog.message_manager.push_message(
                        ...
                        self.dialog.tr("Preview exported to {}").format(
                            output_path.name
                        ),
                        level=Qgis.Success,
                    )
    ...
    def _get_save_path(self) -> Path | None:
        ...
        file_filter = "PNG Image (*.png);;JPEG Image (*.jpg *.jpeg);;PDF Document (*.pdf);;SVG Vector (*.svg)"
    ...
    def export_data(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Exporting data: found {num_interps} interpretation(s) in dialog."
            )
