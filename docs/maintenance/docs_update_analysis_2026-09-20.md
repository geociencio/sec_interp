...
- **Spanish USER_GUIDE translated 100%** (195/195): `es` now meets the ≥80% threshold
  and is publishable. `docs_i18n_status.py` reports overall + `USER_GUIDE` coverage per
  language and marks which languages qualify.
