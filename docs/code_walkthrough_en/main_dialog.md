...
> This 480-line file was decomposed into mixins ([[dialog_mixins]]); `SecInterpDialog` is now a **193-line composition root**.

**Path**: `gui/main_dialog.py` (193 lines; formerly 480)
...
- [[Index]] — vault index
- [[sec_interp_plugin]] — composition root that creates the dialog
- [[controller]] — controller injected via `PreviewService`
- [[adapters]] — adapters injected indirectly
