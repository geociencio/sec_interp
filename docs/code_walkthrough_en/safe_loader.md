...
> It is the piece that enables the **tolerant Composition Root** of [[sec_interp_plugin]] and the service construction in [[controller]].
...
- [[Index]] — vault index
- [[sec_interp_plugin]] — uses `lazy_load` in the Composition Root
- [[controller]] — uses `lazy_load` to build services
