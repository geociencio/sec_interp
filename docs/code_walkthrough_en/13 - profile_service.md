...
> This adapter **does not compute** in the core; it *extracts* and transforms to primitives. The core (`[[10 - controller]]`) receives only ready `ProfileData`.
...
- [[10 - controller]] — orchestrates `extract_profile` in `_process_topography`
- [[11 - domain]] — `ProfileData`
- [[12 - exceptions]] — `DataMissingError`, `GeometryError`
- [[25 - adapters]] — extractor family
