...
| Module | Role |
|--------|------|
| `main_dialog.py` | `SecInterpDialog`: composes managers, mixins, and the window |
...
| `layer_notification_manager.py` | Invalidates the core cache when layers change |
| `ui_status_manager.py` | Indicators and button enablement |
