...
- [[10 - controller]] — orchestrates `_process_geology` (cache + Extract/Compute)
- [[11 - domain]] — `GeologyContext`, `GeologySegment`, `GeologyData`
- [[13 - profile_service]] — extraction of the master profile (topography base)
- [[25 - adapters]] — `GeologyExtractor` (context producer)
