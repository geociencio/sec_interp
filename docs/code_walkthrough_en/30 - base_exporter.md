...
> `ExportManager` (`[[22 - dialog_export_manager]]`) knows only the extension, not concrete classes.
...
- [[22 - dialog_export_manager]] — consumes `BaseExporter` and the factory
- [[31 - vector_exporter]] — generic vector implementation
