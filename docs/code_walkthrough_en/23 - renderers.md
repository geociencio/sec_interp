...
- [[20 - main_dialog]] — orchestrates the preview (creates the `PreviewRenderer` that uses these)
- [[21 - dialog_preview_manager]] — triggers rendering
- [[25 - adapters]] — produce the data these dress
