...
- `sec_interp/` — plugin root
  ...
  - `sec_interp_plugin.py` — Root class `SecInterp` → [[sec_interp_plugin]] · [doc](sec_interp_plugin.md)
...
- `core/` ⚙️ — Business Logic (QGIS-agnostic, thread-safe)
  - `controller.py` — Orchestrator `ProfileController` → [[controller]] · [doc](controller.md)
  - `config.py` → [[config]] · [doc](config.md)
  ...
  - `domain/` — DTOs `ProfileData`, `GeologySegment` → [[domain]] · [doc](domain.md)
  - `validation/` — Modular pipeline → [[validation]] · [doc](validation.md)
    - `validation/pipeline.py`, `layer_validator.py`, `field_validator.py`, `path_validator.py`, `project_validator.py` → [[validation]]
    - `validation/validation_extractor.py` (adapter) → [[validation_extractor]] · [doc](validation_extractor.md)
  ...
  - `services/` — Concrete implementations
    - `services/profile_service.py` → [[profile_service]] · [doc](profile_service.md)
    ...
    - `services/export_service.py` → [[export_service]] · [doc](export_service.md)
...
- `gui/` 🖥️ — UI Layer (QGIS-dependent)
  ...
  - `gui/adapters/` — Extract phase (QGIS → DTOs) → [[adapters]] · [doc](adapters.md)
  ...
  - Managers (orchestration)
    ...
    - `dialog_interpretation_manager.py` → [[interpretation_manager]] · [doc](interpretation_manager.md)
  ...
  - `renderers/` → [[renderers]] · [doc](renderers.md)
    - `renderers/base_renderer.py`, `topo/geology/drillhole/structure/interpretation_renderer.py`
  - `tasks/` (`geology_task.py`, `drillhole_task.py`) → [[tasks]] · [doc](tasks.md)
...
- `exporters/` 📤 — Factory `BaseExporter`
  ...
  - `dxf_exporter.py` → [[dxf_exporter]] · [doc](dxf_exporter.md)
  - `profile_exporters.py` / `csv_exporter.py` → [[profile_exporters]] · [[csv_exporter]] · [doc](csv_exporter.md)
  - `interpretation_3d_exporter.py` → [[interpretation_3d_exporter]] · [doc](interpretation_3d_exporter.md)
  - `interpretation_exporters.py` → [[interpretation_exporters]] · [doc](interpretation_exporters.md)
  - `drillhole_3d_exporter.py` → [[drillhole_3d_exporter]] · [doc](drillhole_3d_exporter.md)
  - `drillhole_exporters.py` → [[drillhole_exporters]] · [doc](drillhole_exporters.md)
  - `pdf_exporter.py` → [[pdf_exporter]] · [doc](pdf_exporter.md)
...
> [!tip] En Obsidian este árbol es navegable: cada `[[slug]]` abre la nota de la bóveda y alimenta el Graph View. En GitHub/Sphinx usa el link `[doc](slug.md)` relativo. Los espejos en `docs/code_walkthrough*/ARCHITECTURE_EN.md` se re-sincronizan con `bash scripts/sync_vault_mirrors.sh`.
