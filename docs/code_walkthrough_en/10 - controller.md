...
> See [[15 - drillhole_service]] for the sub-system breakdown.
...
- [[01 - sec_interp_plugin]] — composition root that injects the adapters
- [[11 - domain]] — DTOs (`PreviewParams`, `GeologySegment`…)
- [[12 - exceptions]] — `ProcessingError`
- [[13 - profile_service]] — topography
- [[14 - geology_service]] — geology
- [[15 - drillhole_service]] — drillholes
- [[25 - adapters]] — Extract-phase extractors
