...
>
> See [[10 - controller]] for the full flow.
...
- [[10 - controller]] — consumes `PreviewParams` and produces the contexts
- [[12 - exceptions]] — domain exceptions
- [[16 - validation]] — parameter and layer validation
- [[25 - adapters]] — producers of `GeologyContext` / `DrillholeContext`
