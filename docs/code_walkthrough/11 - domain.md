...
>
> Ver [[10 - controller]] para el flujo completo.
...
- [[10 - controller]] — consume `PreviewParams` y produce los contextos
- [[12 - exceptions]] — excepciones del dominio
- [[16 - validation]] — validación de parámetros y capas
- [[25 - adapters]] — productores de `GeologyContext` / `DrillholeContext`
