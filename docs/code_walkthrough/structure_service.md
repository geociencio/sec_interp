...
- [[controller]] — orquesta `_process_structures` (closure de elevación)
- [[domain]] — `StructureMeasurement`, `StructureData`
- [[adapters]] — `StructureExtractor` (productor de datos desacoplados)
