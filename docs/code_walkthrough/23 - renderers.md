...
- [[20 - main_dialog]] — orquesta el preview (crea el `PreviewRenderer` que usa estos)
- [[21 - dialog_preview_manager]] — dispara el render
- [[25 - adapters]] — producen los datos que estos visten
