...
> Es la pieza que hace posible el **Composition Root tolerante** de [[01 - sec_interp_plugin]] y la construcción de servicios en [[10 - controller]].
...
- [[01 - sec_interp_plugin]] — usa `lazy_load` en el Composition Root
- [[10 - controller]] — usa `lazy_load` para construir servicios
