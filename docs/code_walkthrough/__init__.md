...
Ver [[sec_interp_plugin]] para el ciclo de vida completo.
...
- [[sec_interp_plugin]] — clase `SecInterp` y ciclo de vida
- [[logger_config]] — logging centralizado
- [[safe_loader]] — carga tolerante a fallos (contraste con este import estricto)
