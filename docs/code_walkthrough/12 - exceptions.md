...
> ```
> Ver [[10 - controller]] para el `try` de 4 niveles en `_get_and_validate_inputs`.
...
- [[10 - controller]] — donde estas excepciones se lanzan y propagan
- [[11 - domain]] — `PreviewParams.validate()` (origen de `ValidationError`)
- [[16 - validation]] — validadores que lanzan `ValidationError` / `ParameterError`
- [[01 - sec_interp_plugin]] — manejo final en la UI
