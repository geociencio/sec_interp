...
> El `ExportManager` (`[[22 - dialog_export_manager]]`) no conoce clases concretas; solo la extensión.
...
- [[22 - dialog_export_manager]] — consume `BaseExporter` y la factory
- [[31 - vector_exporter]] — implementación vectorial genérica
