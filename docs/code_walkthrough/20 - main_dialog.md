...
- [[01 - sec_interp_plugin]] — composition root que crea el diálogo
- [[10 - controller]] — controller inyectado vía `PreviewService`
- [[25 - adapters]] — adapters inyectados indirectamente
- `gui/ui/main_window.py` — UI programática

---

*Nota 20 de la bóveda SecInterp Code Walkthrough — v3.8.0*
