...
> Este adapter **no calcula** en el core; *extrae* y transforma a primitivas. El core (`[[controller]]`) solo recibe `ProfileData` listo.
...
- [[controller]] — orquesta `extract_profile` en `_process_topography`
- [[domain]] — `ProfileData`
- [[exceptions]] — `DataMissingError`, `GeometryError`
- [[adapters]] — familia de extractors
