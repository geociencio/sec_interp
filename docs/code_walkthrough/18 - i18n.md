...
> Ver [[01 - sec_interp_plugin]]: `QTranslator.load(SecInterp_<locale>.qm)` en `SecInterp.__init__`.
...
- [[01 - sec_interp_plugin]] — `SecInterp(TranslatableMixin)` y carga de `.qm`
- [[10 - controller]] — `ProfileController(TranslatableMixin)` usa `self.tr()` en excepciones
- [[12 - exceptions]] — mensajes traducibles que viajan en excepciones

---

*Nota 18 de la bóveda SecInterp Code Walkthrough — v3.8.0*
