...
- [[10 - controller]] — orquesta `_process_geology` (cache + Extract/Compute)
- [[11 - domain]] — `GeologyContext`, `GeologySegment`, `GeologyData`
- [[13 - profile_service]] — extracción del perfil maestro (base topográfica)
- [[25 - adapters]] — `GeologyExtractor` (productor del contexto)
